...
/*$member_id = "";
$member_folder_id = '';
if (isset($_COOKIE["loggedin"]) && isset($_COOKIE["ckfinder"])) {
    if (md5("VM@123").":".$_COOKIE["ckfinder"] == $_COOKIE["loggedin"]) {
        $member_id = base64_decode($_COOKIE["ckfinder"]);
        if (!empty($member_id) && is_numeric($member_id)) {
            $member_folder_id = '/' . $member_id;
        }
    }
}*/

$config['authentication'] = function () {
    global $member_id, $member_folder_id;
    ...
    // return isset($_SESSION['is_allow_ckfinder']) && $_SESSION['is_allow_ckfinder'];
...
$config['licenseName'] = 'weddingguu.com';
$config['licenseKey']  = 'C5U5VQBGWX4J4X3PD4578UQQ1N7J2';
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => '/uploads/ckfinder/userfiles/',

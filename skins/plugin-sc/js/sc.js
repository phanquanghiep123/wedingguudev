...
SC_Visual.prototype = {
    ...
    setup: function() {
        ...
        <script id="map-script" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCirh-rJ2n8PAPc9oDLtSxkaFuqHAiq320&libraries=places"></script>';
    ...
    initloadingStyle: function(choose = false) {
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                var outerWidth = $(".left_col").innerWidth();
                $(".page-wrapper .thems-bg").css({
                    left: "0px",
                    top: "0px",
                    right: "0px",
                    position: "absolute"
    ...
    savePage: function(e) {
        ...
        $.ajax({
            url: _this.$baseurl + "themes/save/" + _this.$id,
            type: "post",
            dataType: "json",
            data: {
                page: sections,

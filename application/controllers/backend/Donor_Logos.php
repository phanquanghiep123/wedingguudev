...
class Donor_Logos extends MY_Controller
{
    private $folder_view = "donor_logos";
    private $base_controller;
    private $table = '';

    public function __construct() {
        parent::__construct();
        $this->table = $this->table_prefix.'donor_logos';
    ...
    public function index(){
        ...
        $this->data["advertisement"] = $this->Common_model->get_result($this->table,$where,$offset,$per_page);

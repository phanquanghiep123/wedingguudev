...
class Musics extends MY_Controller {
  ...
  public $_data  = [];
	...
	public function index (){
		...
		$this->_data["tables"] = $this->{$this->_model}->get(["tbl1.type" => 1],$offset,$limit);
		$total_rows = $this->Common_model->count_table($this->_fix.$this->_table,["type" => 1]);

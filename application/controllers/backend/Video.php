...
class video extends MY_Controller {
    private $folder_view = "video"; 
    private $base_controller;
    private $table = '';
    private $table_member = '';
    public function __construct() {
        parent::__construct();
        $this->table = $this->table_prefix.'video';
    ...
    public function index(){
        ...
        $this->data["data"] = $this->Common_model->get_result($this->table,$where,$offset,$per_page);
    ...
    public function create() {
        if ($this->input->post()) {
            ...
            $this->form_validation->set_rules('url', 'Liên kết', 'required');

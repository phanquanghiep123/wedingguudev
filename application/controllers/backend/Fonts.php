...
{
    private $folder_view = "fonts";
    private $base_controller;
    private $table = '';

    public function __construct() {
        parent::__construct();
        $this->table = $this->table_prefix.'font';
    ...
    public function index(){
        ...
        $this->data["fonts"] = $this->Common_model->get_result($this->table,$where,$offset,$per_page);
    ...
    public function create() {
        if ($this->input->post()) {
            ...
            $this->form_validation->set_rules('path_file', 'File font', 'required');

...
class Countdown extends MY_Controller
{
    ...
    public function __construct() {
        parent::__construct();
        $this->table = $this->table_prefix.'countdown';
    ...
    public function index(){
        ...
        $this->data["countdown"] = $this->Common_model->get_result($this->table,$where,$offset,$per_page);
    ...
    public function create() {
        if ($this->input->post()) {
            ...
            $this->form_validation->set_rules('format', 'Định dạng', 'required');
            $this->form_validation->set_rules('member_id', 'Người dùng', 'required');

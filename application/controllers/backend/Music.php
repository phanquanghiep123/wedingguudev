...
class music extends MY_Controller {
    private $folder_view = "music"; 
    private $base_controller;
    private $table = '';
    private $table_member = '';
    public function __construct() {
        parent::__construct();
        $this->table = $this->table_prefix.'music';
    ...
    public function index(){
        ...
        $this->data["music"] = $this->Common_model->get_result($this->table,$where,$offset,$per_page);
    ...
    public function create() {
        if ($this->input->post()) {
            ...
            $this->form_validation->set_rules('path_file', 'Đường dẫn', 'required');

<div class="is_page priview-page <?php if($this->input->get("iframe")) echo 'view-iframe';?>" id="page_theme" style="opacity: 0">
  <div ng-app="ThemeApp" ng-controller="PageController">
    ...
    <link style-onload="onloadStyle()" ng-if="theme.style_url" rel="stylesheet" type="text/css" ng-href="{{theme.style_url}}">
  </div>
</div>
<!--config theme-->
<!--load font-->

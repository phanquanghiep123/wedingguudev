...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo skin_frontend('bootstrap3.3.7/css/bootstrap.min.css'); ?>">
        ...
        <script src="<?php echo skin_frontend('bootstrap3.3.7/js/bootstrap.js'); ?>"></script>
    ...
    <body id="page-wrapper" class="page <?php echo @$is_home != null && $is_home ? 'home' : 'not-home'; ?>">
        <div id="page" class="site">
          ...
          <?php if(@$is_home != null && $is_home && @$setting['home_list'][0] != null): ?>
              <?php
                  $replace = array('[%skin_frontend%]');
                  $replace_with = array(skin_frontend('/'));

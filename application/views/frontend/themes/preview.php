...
<div class="page" id="sc-preview">
  <div class="builder-loading" style="display: block;"> <img src=<?php echo skin_url("images/spinner-large.png");?>" alt=""> </div>
  <div id="bar-preview">
    <ul class="inline-block">
      <li><a href="<?php echo base_url("themes/create/$id")?>" class="btn btn-info"><i class="fa fa-check" aria-hidden="true"></i> Sử dụng chủ đề này</a></li>
      <li><a href="<?php echo base_url("themes")?>" class="btn btn-info"><i class="fa fa-chevron-left" aria-hidden="true"></i> Chọn chủ đề khác</a></li>
    </ul>
  </div>
...
<div id="sc_script">
   ...
   <script type="text/javascript">
      ...
      $(document).ready (function(){   
         ...
         SC = new SC_Visual($('#wpb_visual'),"<?php echo base_url("/");?>",id,items,"add",themesID);
      });
   </script>
</div>
<script type="text/javascript">
...
<style type="text/css">
  body #bar-preview{
    ...
    background: #9e9095;
    z-index: 9999;
    border-bottom: solid 1px #91818e;
    text-align: right;
    float: right;
    padding: 5px;
  }
  body #editor{margin-top: 50px;}
  body #bar-preview .inline-block {padding: 0 ;margin:0;}
  .inline-block li{display: inline-block;list-style: none;}
  .inline-block a {text-align: center;}
 body .modal{
  z-index: 9999;
 }
</style>
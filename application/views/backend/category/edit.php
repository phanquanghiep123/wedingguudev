    			...
    			<div class="x_content">
    				<form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="featured-image <?php echo @$record['Thumb']!= null ? 'active' : ''; ?>">
                                ...
                                <input name="Thumb" value="<?php echo @$record['Thumb']; ?>" type="hidden" size="60" class="form-control xImagePath">
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Chuyên mục mẹ</label>
                            <select class="form-control required" name="Parent_ID">
                                <option value="0">&mdash; Chuyên mục mẹ &mdash;</option>

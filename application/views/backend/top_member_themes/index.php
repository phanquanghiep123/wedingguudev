                ...
                <div class="x_content">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped jambo_table bulk_action">
                            ...
                            <tbody>
                            <?php if (isset($top_member_themes)): ?>
                                <?php foreach ($top_member_themes as $key => $item) : ?>
                                    <tr>
                                        <td><?php echo ($key+1);?> </td>
                                        <td><img width="150" height="100" src="<?php echo base_url(@$item["image"]); ?>" alt=""></td>
                                        <td><?php echo $item["member_theme_id"]; ?></td>

      ...
      <div id="scrollbars">
        <div id="image" ng-class="tabsectionstyle != 1 ? 'active': ''" class="tab-pane fade in">
          <ul class="nav-list-items list_category">
            ...
            <li openfilemanager="" href="javascript:;" class="ui-button-text" data-action="background-image" data-type="image" data-max="1" id="openFilemanager"><i class="fa fa-list" aria-hidden="true"></i>Mở thư viện file</li>         
            ...
            <li class="item not-after">
              <p>Lặp lại</p>
              <select ng-options="item for item in background_repeat track by item"  id="style-repeat" class="form-control" ng-model="section.style['background-repeat']">
                <option value="">-- chọn một mục --</option>
              </select>
            </li>
            <li class="item not-after">
              <p>Kích cỡ</p>
              <select ng-options="item for item in background_size track by item" class="form-control" id="style-size" ng-model="section.style['background-size']">
                <option value="">-- chọn một mục --</option>
              </select>
            </li>
            <li class="item not-after">
              <p>Vị trí</p>
              <select ng-options="item for item in background_position track by item" class="form-control" id="style-position" ng-model="section.style['background-position']">
                <option value="">-- chọn một mục --</option>
              </select>
            </li>
          </ul>  

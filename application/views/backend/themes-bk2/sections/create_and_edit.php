<div class="is_page" id="page_parts">
  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <form method="post" action="<?php echo ($action_save)?>">
      ...
      <div class="form-group">
        <label for="path_html" class="col-sm-4 col-form-label">Layout</label>
        <div class="col-sm-8">
          <select name="layout_show_block" value="<?php echo @$post["layout_show_block"]?>" class="form-control" required="required">
            <option value="auto">--select a item--</option>

				...
				<div class="x_content">
					...
					<form class="form-horizontal form-label-left" method="post" action="">
						<div class="item form-group"> 
							<label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Tiêu đề <span class="required">*</span></label>
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input value="<?php echo @$record['Module_Name'];?>" id="Module_Name" class="form-control col-md-7 col-xs-12" name="Module_Name" required="required" type="text">
							</div>
						</div>
						<div class="item form-group"> 
							<label class="control-label col-md-3 col-sm-3 col-xs-12" for="Module_Key">Identifier hệ thống <span class="required">*</span></label>
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input value="<?php echo @$record['Module_Key'];?>" id="Module_Key" class="form-control col-md-7 col-xs-12" name="Module_Key" required="required" type="text">
							</div>
						</div>
						<div class="item form-group"> 
							<label class="control-label col-md-3 col-sm-3 col-xs-12" for="Module_Url">Đường dẫn <span class="required">*</span></label>
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input value="<?php echo @$record['Module_Url'];?>" id="Module_Url" class="form-control col-md-7 col-xs-12" name="Module_Url" required="required" type="text">
							</div>
						</div>
						<div class="item form-group"> 
							<label class="control-label col-md-3 col-sm-3 col-xs-12" for="Parent_ID">Chọn chức năng mẹ</label>
							<div class="col-md-6 col-sm-6 col-xs-12"> 
								<select id="Parent_ID" class="form-control col-md-7 col-xs-12" name="Parent_ID">
								    <option value="0">&mdash; &mdash; Chức năng mẹ &mdash; &mdash;</option>
									<?php echo @$option_modules;?>
								</select>
							</div>
						</div>
						<div class="item form-group"> 
							<label class="control-label col-md-3 col-sm-3 col-xs-12" for="Order">Vị thứ</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input value="<?php echo @$record['Order'];?>" id="Order" class="form-control col-md-7 col-xs-12" name="Order"  type="number">
							</div>
						</div>	
						<div class="item form-group"> 
							<label class="control-label col-md-3 col-sm-3 col-xs-12" for="Icon">Icon</label>
							<div class="col-md-6 col-sm-6 col-xs-12"> 
								<input value="<?php echo @$record['Icon'];?>" id="Icon" class="form-control col-md-7 col-xs-12" name="Icon" placeholder="Icon display" type="text" readonly>
						...
						<div class="item form-group"> 
							<label class="control-label col-md-3 col-sm-3 col-xs-12" for="Module_Class">Class</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input value="<?php echo @$record['Module_Class'];?>" id="Module_Class" class="form-control col-md-7 col-xs-12" name="Module_Class" type="text">
							</div>
						</div>
						<div class="item form-group"> 

<div class="is_page priview-page" id="page_theme" style="display:none">
  <div ng-app="ThemeApp" ng-controller="PageController">
    <div id="bar-preview">
      ...
      <ul class="inline-block right">
        <li ng-if="theme.is_system == 1"><a ng-href="<?php echo base_url("appthemes/create/")?>{{theme.slug}}" href="#" class="btn btn-info"><i class="fa fa-check" aria-hidden="true"></i> Dùng</a></li>
    ...
    <div class="{{mode_class}}">
      <sections class="list-sections" ng-style="theme.style">
        <section ng-init="CreateBlockGroup($index)" ng-repeat="section in sections" class="section-item {{section.class_name}}" ramkey="{{section.ramkey}}" ng-attr-data-index="{{$index}}" data-index>
          ...
          <fireworks ng-if="section.class_name == 'section-information' || section.class_name == 'section-count-down'"></fireworks>
          </div>
        </section>
      </sections>
    </div>

...
<body ng-app="ThemeAppIframe" id="body-iframe" ng-controller="PageIframeController">
  ...
  <div class="{{parentWindow.mode_class}}" >
    <sections class="list-sections" ng-style="parentWindow.theme.style">
        <section ng-init="CreateBlockGroup($index)" ng-repeat="section in parentWindow.sections" class="section-item {{section.class_name}}" ramkey="{{section.ramkey}}" ng-attr-data-index="{{$index}}">
          <div id="content-section" ng-class="section.is_full == 0 ? 'container' : 'container-full'" ng-style="section.style">
            <div class="wrapper-section">      
              <div class="default-block block-title" ng-if="parentWindow.mode == 2">
              ...
              <blocks class="list-blocks">
                  ...
                  <div class="row">
                    <block ng-class="[{true :'not-edit'}[block.actions.length == 0],{true : 'active'}[block.active == 1]]" ng-repeat="block in section.blocks_on" class="col-xs-{{block.ncolum}} col-sm-{{block.ncolum}} col-md-{{block.ncolum}} col-lg-{{block.ncolum}} block-item {{block.class_name}}" ramkey={{block.ramkey}} ng-attr-data-index="{{$index}}" data-index >
                      <div class="wrapper-block">
                        <div ng-if="parentWindow.mode != 1" class="menu-action" id="support_block">
                          <ul class="menu-block">
                            <li><a ng-click ="parentWindow.BlockEdit(block,section)" href="javascript:;" id="edit-block"><i class="fa fa-pencil" aria-hidden="true"></i></a></li>
          ...
          <div ng-if="parentWindow.mode != 1" class="menu-action" id="support_section">
            <ul class="menu-block">
              <li><a ng-click="parentWindow.SectionEdit(section)" href="javascript:;" id="edit-action"><i ng-class="section.updateCurrent == 1 ? 'fa-cloud-upload': 'fa-pencil' " class="fa" aria-hidden="true"></i></a></li>
              <li><a ng-click="parentWindow.SectionAdd(section)" href="javascript:;" id="add-action"><i class="fa fa-plus-square" aria-hidden="true"></i></a></li>
              <li><a ng-click="parentWindow.SectionDelete(section)" href="javascript:;" id="delete-action"><i class="fa fa-trash" aria-hidden="true"></i></a></li>
              <li><a ng-click="parentWindow.MovingBlock(section)" href="javascript:;" id="delete-action"><i class="fa fa-arrows" aria-hidden="true"></i></a></li>
              <li><a ng-if="section.more < section.blocks_off.length" ng-click="parentWindow.MoreSection(section)" href="javascript:;"><i class="fa fa-arrow-down" aria-hidden="true"></i></a></li>
            </ul>
          </div>  
        </section>
    </sections>
